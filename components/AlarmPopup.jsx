...
const AlarmPopup = () => {
  ...
  return (
    <div className="bg-white w-full max-w-[700px] border-2 border-slate-300">
        ...
        <p className="text-xl  font-semibold text-[#555555]">Alarm Time: <span className="font-normal text-xl"> {currentAlarmTime}</span></p>
        <button className="cursor-pointer bg-[#0090dd] rounded text-white p-2 " onClick={alarmSound}>Turn Off</button>
        </div>
